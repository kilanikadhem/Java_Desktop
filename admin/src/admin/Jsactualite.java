 ...
 * @author kadhem
 */
public class Jsactualite extends javax.swing.JFrame {

    /**
     * Creates new form Jsactualite
     */ 
    // varible 
    ...
    public Jsactualite() throws SQLException {
        initComponents();
        myinit();
    }
    ...
    if((jtar.getText().length()!=0) && (jtfr.getText().length()!=0)&& (jtxar.getText().length()!=0)&& (jtxfr.getText().length()!=0)){
        try {
 ...
 try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jsactualite.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Jsactualite().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Jsactualite.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
